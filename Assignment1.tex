...
Let the coordinates of points $P_1$ and $P_2$ on x-axis and y-axis of angular axes be ($x_1$,$y_1$) \& ($x_2$,$y_2$) respectively.\\
Let coordinates of the points $P_1$ \& $P_2$ on rectangular axes be ($x_3$,$y_3$) \& ($x_4$,$y_4$) respectively.\\
From the Fig1, \angle$P_1$$X_1$$X_3$ = \angle$P_2$$X_2$$X_4$ = $60^{\circ}$ and \angle$Y_1$$O$$Y_3$ = \angle$Y_2$$O$$Y_4$ = $30^{\circ}$.\\
$x_3$ = O$X_1$ + $X_1$$X_3$ = $x_1$+$y_1\cos{60^{\circ}$$ \tag{1} \\
$y_3$ = O$Y_1$$\cos{30^{\circ}$$ = $y_1$$\cos{30^{\circ}$\\
In matrix notation, we can write the above equation as,
\begin{align}
 \myvec{x_3\\y_3} = \myvec{1 \ \cos{60^{\circ}} \\ 0 \  \cos{30^{\circ}}} \myvec{x_1\\y_1} = \myvec{\frac{13}{2}\\\frac{5\sqrt{3}}{2}}
\end{align}


Similarly for the point $P_2$, we have\\
$x_4$ = O$X_2$ + $X_2$$X_4$ = $x_2$+$y_2$\cos{60^{\circ}$$ \\
$y_4$ = O$Y_2$$\cos{30^{\circ}$$  =\ $y_2$$\cos{30^{\circ}$\\
The matrix notation of the above equations is,
\begin{align}
  \myvec{x_4\\y_4} = \myvec{1 \ \cos{60^{\circ}} \\ 0 \  \cos{30^{\circ}}} \myvec{x_2\\y_2}  = \myvec{10\\3\sqrt{3}}
\end{align}
From the equations (1.0.2) \& (1.0.3), the transformed coordinates of points $P_1$,$P_2$ in vectorial representation are,\\
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\columnwidth,height=3.80cm]{download.png}
    \caption*{}
