...
\end{figure}
The above figure shown is not to the scale}.\\The blue dotted lines represents the projections of the points on the angular axes and the yellow dotted lines represents the projections of the points on the rectangular axes.\\
The same points are plotted in rectangular axes using python
\newpage
